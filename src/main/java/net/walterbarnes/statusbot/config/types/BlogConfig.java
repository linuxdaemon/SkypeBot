...
package net.walterbarnes.statusbot.config.types;

import net.walterbarnes.statusbot.config.DB;
import net.walterbarnes.statusbot.search.SearchExclusion;
        ...
        try (PreparedStatement st = connection.prepareStatement("SELECT * FROM blogs WHERE id = ?::UUID")) {
            ...
            try (ResultSet rs = st.executeQuery()) {
                ...
                while (rs.next()) {
                    ...
                    try {
                        this.postType = (String[]) postType.getArray();
                    } catch (SQLException ignored) {
                        this.postType = new String[0];
                    }
                    ...
                    try {
                        this.postTags = (String[]) postTags.getArray();
                    } catch (SQLException ignored) {
                        this.postTags = new String[0];
                    }
                ...
                LogHelper.info("Config loaded for " + url);
            }
